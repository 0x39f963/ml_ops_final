# Скриншоты (доказательства работы)

Кадры сняты на localhost. На всех - только публичные имена: `client_id`-хэш, `PROD_xx`, `SEG_x`. Реальных ИНН, имен продуктов и названия компании на кадрах нет.
