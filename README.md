...
все кадры с описанием и привязкой к критериям - в галерее: **[screenshots/README.md](screenshots/README.md)**. там docker ps healthy, `/health` 200, swagger, demo топ-10, airflow dag и прогон. полный каталог evidence (с текстовыми логами) - [screenshots/INDEX.md](screenshots/INDEX.md).

---

## mdd / adr (про скорость ответа сервиса)

mdd (metrics-driven development) - архитектурное решение подтверждают статистикой на реальных замерах.
